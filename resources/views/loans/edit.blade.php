                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('update-loan',$loan->loan_id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                    <input type="text" id="name" class="form-control" name="names" value="{{ old('name', $loan->members->name) }}"  required>
                                    <input type="hidden" id="phone" class="form-control" name="phone" value="{{ old('phone', $loan->members->phone) }}" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <select id="interest-rate" class="form-control" name="interest_rate">
                                            <option value="28" {{ old('interest_rate', $loan->interest_rate) == '28' ? 'selected' : '' }}>28%</option>
                                            <option value="4" {{ old('interest_rate', $loan->interest_rate) == '4' ? 'selected' : '' }}>4%</option>
                                            <option value="other" {{ !in_array(old('interest_rate', $loan->interest_rate) , ['28','4']) ? 'selected' : '' }}>Other</option>
                                        </select>
                                    </div>
                                ...
                                <div id="other-interest" class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="other-interest-value" class="form-control"
                                            name="other-interest-value" value="{{old('interest_rate', $loan->interest_rate)}}" >
                                    </div>
                                </div>
                                @endif
