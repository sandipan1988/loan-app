                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('add-member') }}">
                                ...
                                <div class="form-group row">
                                    <label for="date-of-birth" class="col-md-4 col-form-label text-md-right">Date of
                                        Birth</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="date-became-member" class="col-md-4 col-form-label text-md-right">Date
                                        Became Member</label>
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" id="date-became-member"
                                            name="date-became-member">
                                    </div>
                                </div>
