            ...
            <div class="card-body">
              <form method="POST" action="{{route('save-member')}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <input type="date" class="form-control" id="date-became-member" name="date_became_member">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="govt_id" class="col-md-4 col-form-label text-md-right">Govt. ID Card</label>
                  <div class="col-md-4">
